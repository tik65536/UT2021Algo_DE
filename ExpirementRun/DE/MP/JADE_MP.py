...
class JADE_MLP():
    ...
    def fit(self,config,id_,p=None):
        ...
        for e in range(self.epoch):
            ...
            print(f'ConfigID: {id_:3d}, Epoch: {e:3d}, Training Loss: {(batchloss/batch):10.8f}, Validation Loss: {(vloss):10.8f},Best: {best:10.8f}, Accuracy: {accuracy:4:4f}, StopCount/Limit: {stop:3d}/{self.stopcount:3d}, Time:{(end-start):10.8f}')
    ...
    def run(self,beta=0.5,cr=0.9,mp=1):
